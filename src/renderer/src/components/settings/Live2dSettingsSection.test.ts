...
vi.mock('../live2d/CurrentModelCard.vue', () => ({
  default: { template: '<div data-test="current" />' }
}))
vi.mock('../live2d/Live2dPreviewControls.vue', () => ({
  default: { template: '<div data-test="controls" />' }
}))
vi.mock('../live2d/ModelList.vue', () => ({ default: { template: '<div data-test="list" />' } }))
vi.mock('../live2d/ModelImportDropzone.vue', () => ({
  default: { template: '<div data-test="dropzone" />' }
}))
vi.mock('../live2d/ModelValidationResult.vue', () => ({
  default: { template: '<div data-test="validation" />' }
}))
